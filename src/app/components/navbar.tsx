    ...
    <div>
      ...
      {isNavOpen && ( // Render the navigation links if isNavOpen is true
        <div className="flex flex-col lg:hidden ">
          ...
          <a className=" hover:text-blue-700 m-6" href="/about">About </a>
          <a className=" hover:text-blue-700 m-6" href="https://psidh.vercel.app" target="_blank">Resume</a>
          <a className=" hover:text-blue-700 m-6" href="/#footer">Contact</a>
        </div>
      )}
      </div>
  );

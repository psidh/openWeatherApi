...
export default function About() {
  ...
  <Navbar />
    ...
    <div className="container md:mx-auto mr-4 px-6 md:px-8 py-8 text-justify ">
  <h1 className="text-3xl md:text-5xl text-center font-bold text-white dark:text-white py-4 mb-4">
    About
  </h1>
  ...
  <ul className="list-disc text-md md:text-lg list-inside text-white mb-6 pl-4">
  ...
  <h2 className="text-xl md:text-2xl font-semibold text-white dark:text-white mb-4">Technology Stack</h2>
  ...
  <h2 className="text-xl md:text-2xl font-semibold text-white dark:text-white mb-4">How to Use</h2>
  <p className="text-md md:text-lg text-white dark:text-white mb-6">
    Start using Weather App to stay informed about weather conditions in your area or any location of your choice:
  </p>
  <ol className="list-decimal list-inside  text-md md:text-lg  text-white dark:text-white mb-6 pl-4">
